/*****************************************
*
* 	BulkImageLoader.js Originallyfrom 
*		http://rhuno.com/flashblog/2013/09/22/tutorial-loading-images-with-javascript/
*	Few Changes added.
*
*****************************************/
...
function BulkImageLoader()
{
	...
	this.startGameCallback = function() { throw new Error("BulkImageLoader.startGameCallback was not set"); };
